...
def generate_slot_name(pkg_name: str, platform_str: str, slot_type: str, network: str = "bigoads", store_url: str = None, bundle_id: str = None, network_manager=None, app_name: str = None) -> str:
    ...
    # For Mintegral and Pangle, skip BigOAds lookup (pkg_name should already be resolved from apps list)
    # Mintegral and Pangle should use their own app list for package name resolution
    if network.lower() not in ["mintegral", "pangle"] and network_manager and (pkg_name or bundle_id):
